...
export OUTPUT_DIR=./checkpoints/llava-v1.5-7b-calvin-rel-obs-reduce5-action_head-0721
export CALVIN_PROCESSED_JSON_PATH=/data/user/wsong890/user68/project/vlas/playground/task_ABC_D_training_r5.json
export CALVIN_PROCESSED_DIRECTORY=/data/user/wsong890/user68/data/calvin_process/task_ABC_D/vla_processed_r5
